...
import pro.codot.connectors.http.request.RequestBuilder;
import pro.codot.connectors.http.request.impl.BinaryRequestBuilder;
import pro.codot.connectors.http.request.impl.MultipartRequestBuilder;
import pro.codot.connectors.http.request.impl.NoBodyRequestBuilder;
import pro.codot.connectors.http.request.impl.TextRequestBuilder;
import pro.codot.connectors.http.request.payload.BinaryPayload;
import pro.codot.connectors.http.request.payload.EmptyPayload;
